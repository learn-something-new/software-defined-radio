...
class transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/pwntoo/GRC/morse.wav', True)
        ...
        self.connect((self.analog_wfm_tx_0, 0), (self.channels_channel_model_0, 0))
